enum keys {
    ...
    KEY_disjoint, KEY_dsharp, KEY_echo, KEY_essen, KEY_exact, 
    KEY_multi_min,KEY_multi_full, 
    KEY_expand,
...
struct {
    ...
    {"multi_min", KEY_multi_min, 1, TRUE, TRUE},
    {"multi_full", KEY_multi_full, 1, TRUE, TRUE},
